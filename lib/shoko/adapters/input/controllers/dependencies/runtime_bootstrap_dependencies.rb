      ...
      module Controllers
        module Dependencies
          ...
          RuntimeBootstrapDependencies = Data.define(:core, :services, :storage, :sessions, :platform) do
            ...
            RuntimeBootstrapWorkflowBundle = Data.define(
              :navigation_service,
              :bookmark_service,
            ...
            RuntimeBootstrapRenderingBundle = Data.define(
            ...
            RuntimeBootstrapSessionSupportBundle = Data.define(
              :dictionary_service,
            ...
            RUNTIME_SERVICE_WORKFLOW_FIELDS = %i[
              navigation_service
              bookmark_service
              in_book_search_service
              selection_service
            ...
            RUNTIME_SERVICE_RENDERING_FIELDS = %i[
              rendered_content_reader
              annotation_service
              render_registry
              notification_service
            ...
            RUNTIME_SERVICE_SESSION_SUPPORT_FIELDS = %i[
              dictionary_service
              dictionary_catalog_service
              settings_service
              dictionary_availability
            ...
            RUNTIME_SERVICE_FIELDS = (
              RUNTIME_SERVICE_WORKFLOW_FIELDS +
              RUNTIME_SERVICE_RENDERING_FIELDS +
              RUNTIME_SERVICE_SESSION_SUPPORT_FIELDS
            ).freeze
            ...
            class << self
              def build(**kwargs)
                new(
                  ...
                  services: RuntimeBootstrapServiceBundle.new(
                    workflow: RuntimeBootstrapWorkflowBundle.new(**slice(kwargs, RUNTIME_SERVICE_WORKFLOW_FIELDS)),
                    rendering: RuntimeBootstrapRenderingBundle.new(**slice(kwargs, RUNTIME_SERVICE_RENDERING_FIELDS)),
                    session_support: RuntimeBootstrapSessionSupportBundle.new(
                      **slice(kwargs, RUNTIME_SERVICE_SESSION_SUPPORT_FIELDS)
                    )
                  ),
            ...
            RUNTIME_SERVICE_WORKFLOW_FIELDS.each do |field|
              define_method(field) { services.workflow.public_send(field) }
            end

            RUNTIME_SERVICE_RENDERING_FIELDS.each do |field|
              define_method(field) { services.rendering.public_send(field) }
            end

            RUNTIME_SERVICE_SESSION_SUPPORT_FIELDS.each do |field|
              define_method(field) { services.session_support.public_send(field) }
            end
