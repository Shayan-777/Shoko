...
module Shoko
  module Application
    module State
      # Per-path validation helpers for state updates committed through the
      # state store. Encodes type/range invariants for config and UI fields
      # that the store can enforce without consulting fragment-level rules.
