...
require 'shoko/adapters/book_sources/css/element_style_resolver'

RSpec.describe Shoko::Adapters::BookSources::Css::ElementStyleResolver do
  Parser = Shoko::Adapters::BookSources::Css::StylesheetParser
