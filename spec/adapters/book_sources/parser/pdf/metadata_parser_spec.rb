...
require 'spec_helper'
require_relative '../../../../../lib/shoko/adapters/book_sources/pdf/parser/metadata_parser'
require_relative '../../../../../lib/shoko/adapters/book_sources/pdf/parser/pdf_metadata_extractor'
require_relative '../../../../../lib/shoko/adapters/book_sources/pdf/pdf_importer'

RSpec.describe Shoko::Adapters::BookSources::Pdf::MetadataParser do
  describe '.parse' do
  ...
  describe 'delegation' do
    it 'is used by PdfMetadataExtractor and preserves extractor output shape' do
      reader = instance_double(Shoko::Adapters::BookSources::Pdf::PdfReader)
      ...
      result = Shoko::Adapters::BookSources::Pdf::PdfMetadataExtractor.from_file(
        '/tmp/book.pdf',
