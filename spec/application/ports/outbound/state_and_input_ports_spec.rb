...
RSpec.describe 'Application state and boundary port contracts' do
  ...
  it 'defines ReaderPopupControl contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ReaderPopupControl)
    methods = [
  ...
  it 'defines ReaderLifecycleControl contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ReaderLifecycleControl)
    methods = [
  ...
  it 'defines MenuBrowseInspection contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::MenuBrowseInspection)
    methods = [
  ...
  it 'defines MenuDownloadSelection contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::MenuDownloadSelection)
    methods = [
  ...
  it 'defines CatalogRefreshControl contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::CatalogRefreshControl)
    methods = [
  ...
  it 'defines DisplayMetadataCache contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::DisplayMetadataCache)
    methods = [
  ...
  it 'defines MenuAnnotationControl contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::MenuAnnotationControl)
    methods = [
  ...
  it 'defines ApplicationExitControl contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ApplicationExitControl)
    methods = [
  ...
  it 'defines ReaderDocumentLocator contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ReaderDocumentLocator)
    methods = [
  ...
  it 'defines ReaderRuntimeContext contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ReaderRuntimeContext)
    methods = [
      [:terminal_size, [], nil],
  ...
  it 'defines MenuReaderRuntime contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::MenuReaderRuntime)
    methods = [
  ...
  it 'defines ReaderRenderRequester contract methods' do
    implementation = build_implementation(Shoko::Application::Ports::Outbound::ReaderRenderRequester)
    methods = [
  ...
  it 'defines FolderScanner and FolderImporter contract methods' do
    scanner = build_implementation(Shoko::Application::Ports::Outbound::FolderScanner)
    importer = build_implementation(Shoko::Application::Ports::Outbound::FolderImporter)
