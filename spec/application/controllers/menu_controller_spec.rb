...
RSpec.describe Shoko::Application::Controllers::MenuController do
  ...
  describe 'initialization' do
    let(:container) { Shoko::Application::Composition::ContainerFactory.create_default_container }

    it 'creates successfully with dependency container' do
      menu = Shoko::Application::Composition::ContainerFactory.build_menu_controller(container)
  ...
  describe 'screen components' do
    let(:container) { Shoko::Application::Composition::ContainerFactory.create_default_container }
    let(:menu) { Shoko::Application::Composition::ContainerFactory.build_menu_controller(container) }
