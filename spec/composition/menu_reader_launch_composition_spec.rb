...
RSpec.describe 'Menu reader launch composition' do
  ...
  let(:source_context) do
    SourceContext.new(
      ...
      dictionary_service: Object.new,
      clipboard_service: Object.new,
      translation_model_store: Object.new,
      translation_model_catalog: Object.new,
      dictionary_storage: Object.new,
      annotation_service: Object.new,
      rss_reader_service: Object.new,
