...
RSpec.describe 'Metadata parser schema contract' do
  it 'enforces canonical parser schema for PDF metadata parser' do
    metadata = Shoko::Core::BookFormats::Pdf::MetadataParser.parse(
      title: 'Title',
      author: 'Author',
  ...
  it 'enforces canonical parser schema for RTF metadata parser' do
    ...
    metadata = Shoko::Core::BookFormats::Rtf::MetadataParser.parse(doc: doc, fallback_title: 'Fallback')
  ...
  it 'enforces canonical parser schema for FB2 metadata parser' do
    ...
    metadata = Shoko::Core::BookFormats::Fb2::MetadataParser.parse_document(doc)
  ...
  it 'enforces canonical parser schema for Kindle metadata parser' do
    ...
    metadata = Shoko::Core::BookFormats::Kindle::MetadataParser.parse(
      mobi: mobi,
      exth: exth,
