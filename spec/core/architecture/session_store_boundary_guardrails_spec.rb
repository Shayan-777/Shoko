...
RSpec.describe 'Session store boundary guardrails' do
  ...
  it 'keeps migrated phase-3 application files off state-slice reader/writer ports' do
    forbidden_patterns = [
      %r{application/ports/outbound/config_reader},
      %r{application/ports/outbound/ui_state_reader},
      %r{application/ports/outbound/reader_navigation_reader},
      %r{application/ports/outbound/sidebar_state_reader},
      %r{application/ports/outbound/menu_state_reader},
      %r{application/ports/outbound/pagination_state_writer},
      %r{application/ports/outbound/reader_state_writer},
      %r{application/ports/outbound/menu_state_writer},
      %r{application/ports/outbound/menu_workflow_state_writer},
      %r{application/ports/outbound/ui_loading_writer},
      %r{application/ports/outbound/render_state_writer},
      /\bConfigReader\b/,
      /\bUiStateReader\b/,
