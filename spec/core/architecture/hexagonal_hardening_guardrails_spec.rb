...
RSpec.describe 'Hexagonal hardening guardrails' do
  ...
  it 'forbids deprecated UI-shaped core menu ports in application layer' do
    ...
    patterns = {
      ...
      'menu_state_writer port' => /core\/ports\/outbound\/menu_state_writer|\bApplication::Ports::Outbound::MenuStateWriter\b/,
      'menu_workflow_state_writer port' => /core\/ports\/outbound\/menu_workflow_state_writer|\bApplication::Ports::Outbound::MenuWorkflowStateWriter\b/,
